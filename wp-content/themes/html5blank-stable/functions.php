<?php
/*
 *  Author: Gerrett Rice | @gerrettrice
 *  URL: gerrettrice.com | @html5blank
...
function html5blank_header_scripts() {
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('main', get_template_directory_uri() . '/js/main.js', array('jquery'), '1.0.0', true); // Custom scripts
...
function html5blank_styles()
{
    ...
    wp_register_style('stylesheet', get_template_directory_uri() . '/css/stylesheet.css', array(), '1.0', 'all');
    wp_enqueue_style('stylesheet'); // Enqueue it!

    wp_register_style('slick-theme', get_template_directory_uri() . '/slick/slick-theme.css', array(), '1.0', 'all');
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Site Sidebar', 'html5blank'),
        'id' => 'widget-area-1',
    ...
    // Define Footer - Left Widget Area 1
    register_sidebar(array(
        'name' => __('Footer - Left', 'html5blank'),
        'description' => __('Widgets for the left side of the Footer', 'html5blank'),
    ...
    // Define Footer - Center Widget Area 1
    register_sidebar(array(
        'name' => __('Footer - Center', 'html5blank'),
        'description' => __('Widgets for the center of the Footer', 'html5blank'),
    ...
    // Define Footer - Right Widget Area 1
    register_sidebar(array(
        'name' => __('Footer - Right', 'html5blank'),
        'description' => __('Widgets for the right side of the Footer', 'html5blank'),
